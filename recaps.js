const schedule = [
  ...
  },
  {
    ...
    Hunter Greene pitched 7 innings of 3-hit ball for the Reds, allowing the one run, walking 1, and striking out 8. Jacob Webb, Robert Garcia, Chris Martin, and Luke Jackson combined to shutout the Reds over the last 4 innings, and the Rangers won back-to-back 1-0 games for the first time in their history.`
    },
    {
    id: 'apr4',
    date: 'April 4',
