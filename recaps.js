const schedule = [
  ...
  },
  {
    ...
    opp: 'at Cincinnati',
    score: 'W 1-0',
    recap: `Nathan Eovaldi was brilliant, throwing a complete game 4-hit shoutout, striking out 8 and walking none. Reds starting pitcher Carson Spiers was unimpressive in 2024 with an ERA of 5.64 ERA and an opponent batting avg of .297 But the Rangers lineup needed all of Eovaldi's excellence as Spiers and a trio of Reds relievers held them to a single run on 4 hits. The lone run came in the 1st inning on Wyatt Langford's 361-foot HR to LF. Eovaldi retired Elly De LA Cruz on a bouncing ball to 1B to end the game with the tying run at 2nd.`
    },
    {
    id: 'apr2',
    date: 'April 2',
