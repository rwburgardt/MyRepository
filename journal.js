const schedule = [
  ...
  opp: 'at Chicago Cubs',
  score: 'L 10-6',
  recap: `A Rangers late inning defensive lapse proved costly. Starting pitchers were Patrick Corbin versus Jameson Taillon (1-1, 6.35). Corbin, making his first start, was called up from Round Rock to replace injured Jack Leiter. Jonah Heim plated 2 with a 1-out bases-loaded single in the 2nd, and Taveras and Semien failed to score Jung from 3rd. The Cubs countered with 3 in the bottom half, but Langford tied it in the 3rd with a 407-foot HR to left. Corbin was finished afer 4, giving up 3 runs on 5 hits and 2 walks. Jacob Webb was greeted with 3 singles in the 5th and all 3 eventually scored. In the 7th a double by Jung and a triple by Taveras cut the lead to 6-5. A 2-out single by Josh Smith in the 8th followed by a triple by Josh Jung tied the game at 6, but Heim left Jung stranded at 3rd. In the bottom of the inning Leody Taveras misplayed a deep flyball to CF for a leadoff 2-base error. After an intentional walk and an error by Josh Jung on a potential double-play grounder loaded the bases with 1 out, a 2-run double by the Cubs' Dansby Swanson drove in the winning runs.`
  },  
  {
  id: 'apr9',
  date: 'April 9',
